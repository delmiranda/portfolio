  function formValidation()
  {
    ...
    var countInput = 0;
    if(name == '') { setErrorMessage('.input-name', 'Please enter your name'); countInput++; } else { $('.input-name > .form-response').detach(); }
    if(email == '') { setErrorMessage('.input-email', 'Please enter your email'); countInput++; } else { $('.input-email > .form-response').detach(); }
    if(message == '') { setErrorMessage('.input-message', 'Please enter your message'); countInput++; } else { $('.input-message > .form-response').detach(); }
    return countInput;
  }
